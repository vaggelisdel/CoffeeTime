      ...
      <ul class="sidebar-menu">
		...
		<li class="active treeview">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="addnotification.php"><i class="fa fa-circle-o"></i>Δημιουργία</a></li>
          </ul>
        </li>
		<li class="treeview">
          <a href="#">
        ...
        <div class="col-md-8">
		   ...
		   <div class="box box-info">
            <div class="box-header with-border">
              <h3 class="box-title">Προσθήκη ειδοποίησης</h3>
			  <div class="box-tools pull-right">

              </div>
			  <div class="box-body">
				<form action="redirect-notify.php" method="POST">
					<textarea class="addnewmsg" id="field" onkeyup="countChar(this)" class="message" name="message" rows="5"></textarea><br>
					<div class="inlinechar"><div id="charLeft"></div><div id="charNum" style="margin-left:5px;"></div></div>
					<input type="hidden" class="notifybtn" name="adminid" value="<?php echo $_SESSION['adminid']; ?>">
					<input type="submit" name="notificationbtn" class="notificationbtn" value="Υποβολη">
				</form>
</div>
</div>
...
<script src="dist/js/demo.js"></script>
    ...
    <script>
	$('#charLeft').text("Εναπομείναντες χαρακτήρες: 1000");
      function countChar(val) {
        var len = val.value.length;
        if (len >= 1000) {
          val.value = val.value.substring(0, 1000);
        } else {
		  $('#charLeft').text("Εναπομείναντες χαρακτήρες: ");
