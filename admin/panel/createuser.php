      ...
      <ul class="sidebar-menu">
		...
		<li class="active treeview">
          ...
          <ul class="treeview-menu">
			...
			<li class="active"><a href="createuser.php"><i class="fa fa-circle-o"></i>Δημιουργία</a></li>
          </ul>
        </li>
		<li class="treeview">
          <a href="#">
  ...
  <div class="content-wrapper">
	...
	?>
		   ...
		   <div class="box box-info">
			...
			<form action="confirm_user_create.php" method="post" autocomplete="off">
			<div class="inlinedisplay">
				<div class="col-sm-6">
					<p>Τωρινή Ημερομηνία: <b><?php echo $datetime["datetime"]; ?></b></p>	
				</div>
				<div class="col-sm-6">
					<button id="addnewuser" name="addnewuser" class="btn btn-danger updatechanges">Αποθήκευση και κλείσιμο</button>
					<button id="addnewuserandnew" name="addnewuserandnew" class="btn btn-danger updatechanges">Αποθήκευση και δημιουργία νέου</button>
				</div>
			</div>
			  <div class="box-body">
                                ...
                                <div class="form-horizontal form-material">
                                    <div class="form-group col-sm-12">
                                        <div class="flex_error"><label>User Name</label><span id="availability"></span></div>
                                            <input required type="text" id="username" name="username_new" value="" class="form-control form-control-line">
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label>First Name</label>
                                            <input required type="text" name="firstname_new" value="" class="form-control form-control-line">
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <label>Last Name</label>
                                            <input required type="text" name="surname_new" value="" class="form-control form-control-line" name="example-email" id="example-email">
                                    </div>
									<div class="form-group col-sm-6">
                                        <label>Password</label>
                                            <input required type="password" name="password_new" value="" class="form-control form-control-line">
                                    </div>
                                    <div class="form-group col-sm-6">
                                        <div class="flex_error"><label>Email</label><span id="availability1"></span></div>
                                            <input required type="email" id="email" name="email_new" value="" class="form-control form-control-line">
                                    </div>
									<div class="form-group col-sm-12">
                                        <div class="flex_error"><label>Description</label><span id="availability1"></span></div>
                                            <input required type="text" name="description_new" value="" class="form-control form-control-line">
                                    </div>
                                </div>
                            </div>
                        </div>	
